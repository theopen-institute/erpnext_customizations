...
frappe.ui.form.on('Payroll Booking', {
	onload: function (frm) {
	...
	create_missing_slips: function(frm) {
		...
		frappe.call({
			...
			doc: frm.doc,
			freeze:true,
			freeze_message: 'Drafting new salary slips...'
		})
	},
	...
	setup: function (frm) {
		...
		//frm.toggle_display('create_missing_slips', false)
	},

	payroll_frequency: function (frm) {
		frm.trigger("set_start_end_dates");
		frm.set_value('salary_slips', []);
		frm.trigger("find_relevant_employees");
	},
